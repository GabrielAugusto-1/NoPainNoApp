...
export default function Produtos() {
  ...
  useEffect(() => {
    ...
    const maxPrice = Number(maxPriceFilter.replace(",", "."));
    ...
    const filtered = products.filter((item: any) => {
      ...
      const matchesCategory =
        !normalizedCategory ||
        categoria.includes(normalizedCategory);

      const matchesPrice =
        !maxPriceFilter || preco <= maxPrice;

      return matchesSearch && matchesCategory && matchesPrice;
    });

    setFilteredProducts(filtered);
  }, [products, search, categoryFilter, maxPriceFilter]);
  ...
  return (
    ...
    <View style={styles.container}>
      ...
      {(search || categoryFilter || maxPriceFilter) && (
        <TouchableOpacity
